...
if __name__ == "__main__":
    ...
    print("Операция №2 - получает список всех вакансий с указанием названия компании, "
    ...
    print("Операция #5 - получает список всех вакансий, в названии которых содержатся переданные в метод слова,"
          " например python.")
        ...
        if operation_number == "1":
            try:
                ...
                for company in companies_data:
                    print(
                        f"Компания: {company['company_name']}, " f"Количество вакансий: {company['vacancies_count']}"
                    )
            ...
            print("Операция №2 - получает список всех вакансий с указанием названия компании,"
                  "названия вакансии и зарплаты и ссылки на вакансию.")
            print("Операция №3 - получает среднюю зарплату по вакансиям.")
            print("Операция №4 - получает список всех вакансий, у которых зарплата выше средней по "
                  "всем вакансиям.")
            print("Операция #5 - получает список всех вакансий, в названии которых содержатся переданные "
            ...
            print("Операция №2 - получает список всех вакансий с указанием названия компании, "
                  "названия вакансии и зарплаты и ссылки на вакансию.")
            print("Операция №3 - получает среднюю зарплату по вакансиям.")
            print("Операция №4 - получает список всех вакансий, у которых зарплата выше средней "
                  "по всем вакансиям.")
            print(
                "Операция #5 - получает список всех вакансий, в названии которых содержатся переданные в метод"
            ...
            print("Операция №4 - получает список всех вакансий, у которых зарплата выше средней "
                  "по всем вакансиям.")
            print("Операция #5 - получает список всех вакансий, в названии которых содержатся "
